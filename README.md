<div style="clear: both;">
  ...
  <h3>👾 Script</h3><br>
  <blockquote>Um bot para discord, feito com o objetivo de ajudar servidores. Conta com diversas categorias, entre elas temos: <strong>moderação</strong>, <strong>música</strong>, <strong>entretenimento</strong>, <strong>economia</strong> e <strong>utilidades</strong>.</blockquote>
